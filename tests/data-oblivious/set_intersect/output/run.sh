#!/bin/bash
bazel run //tools:heir-opt -- --mlir-to-openfhe-bgv='entry-function=set_intersect ciphertext-degree=32' $PWD/tests/data-oblivious/set_intersect/set_intersect.mlir > $PWD/tests/data-oblivious/set_intersect/output/openfhe_bgv.mlir
