...
# Run mlir-cpu-runner
bazel-bin/external/llvm-project/mlir/mlir-cpu-runner -e main -entry-point-result=struct $PWD/tests/data-oblivious/set_intersect/output/set_intersect_do_llvm.mlir
